Ext.define('APP.view.rd.trade.balance.agent',{
	...
	store:{
		...
		proxy:{extraParams:{menu:'balance',field:'agent'}}
	},
	dockedItems:[
	...
	columns:[
		...
		{text:'时间',dataIndex:'close_time',xtype:'datecolumn',format:'Y-m-d H:00',width:120},
