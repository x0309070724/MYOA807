Ext.define('APP.view.rd.trade.history.deposit',{
	...
	columns:[
		...
		{text:'金额',dataIndex:'profit',tdCls:'x-ui-active x-ui-text-green',align:'right',minWidth:120,renderer:'returnShowMoney',summaryType:'sum',summaryRenderer:'returnShowMoney'},
