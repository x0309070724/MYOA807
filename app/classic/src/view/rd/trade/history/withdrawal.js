Ext.define('APP.view.rd.trade.history.withdrawal',{
	...
	columns:[
		...
		{text:'金额',dataIndex:'profit',tdCls:'x-ui-active x-ui-text-red',align:'right',minWidth:120,renderer:'returnShowMoney',summaryType:'sum',summaryRenderer:'returnShowMoney'},
