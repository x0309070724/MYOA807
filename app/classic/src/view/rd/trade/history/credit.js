Ext.define('APP.view.rd.trade.history.credit',{
	...
	columns:[
		...
		{text:'到期时间',dataIndex:'expiration',xtype:'datecolumn',format:'Y-m-d H:i:s',minWidth:140},
		{text:'金额',dataIndex:'profit',tdCls:'x-ui-active',align:'right',minWidth:120,renderer:'returnColorMoney',summaryType:'sum',summaryRenderer:'returnColorMoney'},
