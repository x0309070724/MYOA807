Ext.define('APP.view.hr.staff.change.leaving',{
    extend:'Ext.Container',
    controller:'hr.staff.change',
	layout:{type:'border',align:'stretch',padding:3},
	defaults:{split:true},
	items:[
		{xtype:'grid',region:'west',title:'在职员工',collapsible:true,width:600,
			reference:'gridBase',
			store:{
				type:'hrStaff',
				autoLoad:true,
			...
			listeners:{
				itemdblclick:'onChangeLeavingClick'
			}
	   	},
		{xtype:'grid',region:'center',title:'离职记录',
			...
			columns:[
				...
				{text:'在职',dataIndex:'work_day',width:80,align:'right',renderer:'returnDays'},
				{text:'离职日期',dataIndex:'date',width:100},
