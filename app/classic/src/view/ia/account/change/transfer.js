Ext.define('APP.view.ia.account.change.transfer',{
    extend:'Ext.Panel',
	...
	items:[
		{xtype:'grid',region:'center',title:'账户',flex:.5,
			...
			dockedItems:[
				{dock:'top',xtype:'toolbar',items:[
					{xtype:'searchbar',
						fields:[
							{emptyText:'组...',xtype:'comboAccountGroup'},
							{emptyText:'销售A...',xtype:'comboCompanyStaff',root:103,name:'salesmanid',width:100},
							{emptyText:'销售B...',xtype:'comboCompanyStaff',root:103,name:'salesman2id',width:100},
			...
			columns:[
				//{xtype:'rownumberer'},
				{text:'账号',dataIndex:'login',minWidth:140,renderer:'returnLogin'},
		...
		{xtype:'grid',region:'east',title:'待交接的账户',flex:.5,collapsible:true,
			reference:'beingGrid',
			store:{			
				autoLoad:false,
				remoteSort:false,
			...
			dockedItems:[
				{dock:'top',xtype:'toolbar',items:[
					'->',
					{iconCls:'f-mt mt-account-update',text:'交接',handler:'onAccountBatchTransferClick'}
				]}
			],
			forceFit:true,
			viewConfig:{enableTextSelection:false},
