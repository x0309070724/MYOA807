Ext.define('APP.view.ia.account.form.confirm',{
	...
	items:[
		{title:'账户信息',items:[
			{columnWidth:.3,items:[
				...
				{fieldLabel:'代理级别',xtype:'comboIblevel',name:'iblevel',allowBlank:false,hidden:true,disabled:true,bind:{hidden:'{!form.agent}',disabled:'{!form.agent}'},readOnly:true},
			...
			{columnWidth:.4,items:[
				...
				{fieldLabel:'颜色',xtype:'colorfield',name:'user_color',format:'#HEX6',readOnly:true}
				
			]},
			{columnWidth:.3,items:[
				{fieldLabel:'组',xtype:'comboAccountGroup',name:'group',readOnly:true},
			...
			{columnWidth:1,items:[
				{xtype:'checkboxgroup',fieldLabel:'控制项',columns:8,allowBlank:true,items:[
					{boxLabel:'启用',name:'enable',inputValue:1,checked:true,readOnly:true},
					{boxLabel:'更改密码',name:'enable_change_password',inputValue:1,checked:true,readOnly:true},
					{boxLabel:'发送报告',name:'send_reports',inputValue:1,checked:true,readOnly:true},
					{boxLabel:'只读账户',name:'enable_read_only',inputValue:1,readOnly:true}
				]}
			]}
		]},
		{title:'审核结果',items:[
			{columnWidth:.5,items:[
				{xtype:'radiogroup',columns:4,fieldLabel:'审核结果',
					items:[
						{boxLabel:'通过',name:'confirm',inputValue:1,checked:true,reference:'fieldAudit'},
						{boxLabel:'拒绝',name:'confirm',inputValue:-1}
					]
				}
			]},
...
//			]},
			{columnWidth:1,items:[
				{fieldLabel:'原因',xtype:'textarea',name:'confirm_explain',height:50,allowBlank:false,disabled:true,bind:{disabled:'{fieldAudit.checked}'}}
			]},
