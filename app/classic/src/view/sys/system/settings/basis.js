Ext.define('APP.view.sys.system.settings.basis', {
  extend: 'Ext.form.Panel',
  xtype: 'sysSystemSettingsBasis',
  ...
  items: [
    ...
    },
    {
      ...
      {
        columnWidth: .4, items: [{
        fieldLabel: '优先显示', xtype: 'radiogroup', columns: 3,
        items: [
    ...
    },
    {
      ...
      {
        columnWidth: .3,
        items: [{fieldLabel: '商户号', xtype: 'numberfield', name: 'smsmate_merchantno', minLength: 6, maxLength: 6}]
      },
      {
        columnWidth: .7,
        items: [{fieldLabel: '密钥', xtype: 'passwordfield', name: 'smsmate_merchantkey', minLength: 32, maxLength: 32}]
      }
    ]
    },
    {
