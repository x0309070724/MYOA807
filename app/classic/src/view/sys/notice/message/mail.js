Ext.define('APP.view.sys.notice.message.mail', {
  ...
  dockedItems: [
    {
      ...
      items: [
        ...
        //{iconCls:'f-mt mt-delete',text:'删除',disabled:true,selection:true,handler:'onMailRemoveClick'},
        '-',
        {xtype: 'refreshbutton'}
      ]
    },
  ...
  columns: [
    ...
    {text: '发送时间', dataIndex: 'sendtime', xtype: 'datecolumn', format: 'Y-m-d H:00'},
    {
      ...
      {text: '邮箱', dataIndex: 'sendno', width: 200}
    ]
    },
    {
    ...
    {text: '通知内容', dataIndex: 'title', renderer: 'returnMore', flex: 1}
  ],
