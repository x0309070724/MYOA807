Ext.define('APP.view.sd.staff.csr.recordIb',{
    extend:'Ext.grid.Panel',
	store:{
		type:'account.manager',
		autoLoad:true,
		grouper:{groupFn:function(record){return Ext.Date.format(record.data.regdate,'Y-m')},property:'regdate',direction:'DESC'},
		proxy:{extraParams:{type:'ib',staff:1}}
	},
	columns:[
		{xtype:'rownumberer'},
		...
		{text:'账户信息',defaults:{sortable:true,width:80},columns:[
			{text:'开户月份',dataIndex:'regdate',xtype:'datecolumn',format:'Y-m'},
			{text:'日期',dataIndex:'regdate',xtype:'datecolumn',format:'m-d H:i A',width:120},
