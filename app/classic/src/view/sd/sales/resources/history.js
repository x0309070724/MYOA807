Ext.define('APP.view.sd.sales.resources.history',{
    extend:'Ext.Container',
    controller:'sd.sales',
	padding:1,
	layout:{type:'hbox',align:'stretch'},
	items:[
		{xtype:'grid',title:'销售日报',width:400,
			reference:'gridTotal',
			store:{
		...
		{xtype:'grid',title:'销售记录',minWidth:600,flex:1,margin:'0 0 0 1',
			...
			store:{
				...
				proxy:{extraParams:{app:'resources',startdate:Ext.Date.format(new Date(),'Y-m-d'),enddate:Ext.Date.format(new Date(),'Y-m-d')}}
			},
			dockedItems:[
				{dock:'top',xtype:'toolbar',items:[
					{xtype:'searchbar',
			...
			columns:[
				...
				{text:'评星',xtype:'widgetcolumn',dataIndex:'rating',width:88,widget:{xtype:'rating',readOnly:true}},				
				{text:'已跟进',dataIndex:'track_staff_count',width:88,renderer:'returnSalesResTrackHistory'},
