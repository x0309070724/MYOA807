Ext.define('APP.view.sd.mgr.funds.record',{
    extend:'Ext.Panel',
	layout:'fit',
    controller:'ia.funds',
	...
	dockedItems:[
		{dock:'top',xtype:'toolbar',items:[
			{xtype:'segmentedbutton',defaults:{minWidth:60},reference:'funds',
				items:[
					{text:'入金',widget:'sd.mgr.funds.recordDeposit',pressed:true},
					{text:'出金',widget:'sd.mgr.funds.recordWithdrawal'},
					{text:'信用',widget:'sd.mgr.funds.recordCredit'},
					{text:'转账',widget:'sd.mgr.funds.recordTransfer'}
				],
				listeners:{ 
