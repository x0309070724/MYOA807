Ext.define('APP.view.sd.mgr.csr.record',{
    extend:'Ext.Panel',
	layout:'fit',
	...
	dockedItems:[
		{dock:'top',xtype:'toolbar',items:[
			{xtype:'segmentedbutton',defaults:{minWidth:60},reference:'csr',
				items:[
					{text:'IB',widget:'sd.mgr.csr.recordIb'},
					{text:'IBC',widget:'sd.mgr.csr.recordIbc'},
					{text:'SH',widget:'sd.mgr.csr.recordSh'},
					{text:'ALL',widget:'sd.mgr.csr.recordAll',pressed:true}
				],
				listeners:{ 
