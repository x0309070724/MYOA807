Ext.define('APP.view.sd.mgr.work.analysis.sales.timeChart',{
			...
			menu:{
				...
				call:{
					...
					items:[
						...
						{text:'平均时长',field:'call_duration_average',title:'趋势·平均时长'},
						{text:'通话时长',field:'call_duration',title:'趋势·通话时长'}
					]
				}
			}
		}}
