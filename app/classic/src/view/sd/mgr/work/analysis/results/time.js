Ext.define('APP.view.sd.mgr.work.analysis.results.time',{
    extend:'Ext.Panel',
	layout:'fit',
	...
	dockedItems:[
		{dock:'top',xtype:'toolbar',items:[
			{xtype:'segmentedbutton',name:'menu',defaults:{minWidth:100},
				items:[
					{text:'报表',widget:'sd.mgr.work.analysis.results.timeGrid',pressed:true},
					{text:'分析',widget:'sd.mgr.work.analysis.results.timeChart'}
				],
				listeners:{ 
