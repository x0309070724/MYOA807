Ext.define('APP.view.sd.mgr.work.report.res',{
    extend:'Ext.Container',
    controller:'sd.mgr.res',
	padding:1,
	layout:{type:'hbox',align:'stretch'},
	items:[
		{xtype:'grid',title:'销售报表',width:480,
			reference:'gridTotal',
			store:{
		...
		{xtype:'grid',title:'销售记录',minWidth:600,flex:1,margin:'0 0 0 1',
			...
			store:{
				...
				proxy:{extraParams:{app:'resources',staffid:-1,startdate:Ext.Date.format(Ext.Date.add(new Date(),Ext.Date.DAY,-1),'Y-m-d'),enddate:Ext.Date.format(new Date(),'Y-m-d')}}
			},
			dockedItems:[
				{dock:'top',xtype:'toolbar',items:[
					{xtype:'searchbar',
