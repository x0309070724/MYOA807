Ext.define('APP.model.account.funds',{
	...
	fields:[
		...
		{name:'bank_currency',type:'string'},{name:'bank_icon',type:'string'},{name:'bank_name',type:'string'},{name:'bank_branch',type:'string'},{name:'bank_username',type:'string'},{name:'bank_cardno',type:'string'},{name:'bank_address',type:'string'},{name:'bank_swiftcode',type:'string'},
		{name:'audit',type:'int'},
		...
		{name:'salesmanid',type:'int'},{name:'salesman_name',type:'string'},{name:'salesman_namecn',type:'string'},
		{name:'salesman2id',type:'int'},{name:'salesman2_name',type:'string'},{name:'salesman2_namecn',type:'string'},
		{name:'account_typeid',type:'int'},{name:'account_namecn',type:'string'},{name:'account_name',type:'string'},{name:'account_mobile',type:'string'},{name:'account_email',type:'string'},
		{name:'agent',type:'int'},{name:'agent_name',type:'string'},{name:'agent_namecn',type:'string'},

		{name:'account_balance',type:'number'},{name:'account_credit',type:'number'},{name:'account_equity',type:'number'},{name:'account_margin',type:'number'},{name:'account_margin_free',type:'number'},{name:'account_margin_level',type:'number'},
