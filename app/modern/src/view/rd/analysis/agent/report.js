Ext.define('APP.view.rd.analysis.agent.report',{
	...
	items:[
		...
		{xtype:'segmentedtab',ui:'tab',name:'field',bind:{value:'{parameter.field}'},
			items:[
				{text:'开户量',iconCls:'f-mt mt-field-account',value:'account',sorter:{property:'account_new_count',direction:'DESC'}},
				{text:'净入金',iconCls:'f-mt mt-field-funds',value:'funds',sorter:{property:'funds_net_deposit',direction:'DESC'}},
				{text:'佣金',iconCls:'f-mt mt-field-agent',value:'agent',sorter:{property:'trade_commission_agent',direction:'DESC'}},
				{text:'净盈亏',iconCls:'f-mt mt-field-clear',value:'trade',sorter:{property:'trade_clear',direction:'DESC'}}
			]
		},
		{xtype:'boxtotal'}
	],
