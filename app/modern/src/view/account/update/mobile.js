Ext.define('APP.view.account.update.mobile',{
	...
	setFieldset:function(){
		...
		if(account.mobile==''){
			...
			mateNew.setItems([
				{xtype:'numberfield',inputType:'tel',name:'newValue',label:'手机',maxLength:11,minLength:11,placeholder:'eg. 18688886666'}
			]);
		}else{
			button.setText('确认更换');
			mateNow.show();
			...
			mateNew.setItems([
				{xtype:'numberfield',inputType:'tel',name:'newValue',label:'新手机号',maxLength:11,minLength:11,placeholder:'eg. 18688886666'}
			]);
		}
	}
});
